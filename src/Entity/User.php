...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    public function addBacklog(Backlog $backlog): static
    {
    ...
    public function removeBacklog(Backlog $backlog): static
    {
